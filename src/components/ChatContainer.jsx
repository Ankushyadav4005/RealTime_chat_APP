...
useEffect(()=>
{
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      {/* --------bottom area------- */}
      <div className='absolue bottom-0 left-0 flex items-centre gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
        <input type='type' placeholder='send a message'  className='flex-1 txt-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-400'/>
